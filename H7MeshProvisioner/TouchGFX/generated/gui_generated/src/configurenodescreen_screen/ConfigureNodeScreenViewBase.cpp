    ...
    buttonCallback(this, &ConfigureNodeScreenViewBase::buttonCallbackHandler)
{
    ...
    GUI_ConfLoaderPopup.setBackground(touchgfx::BitmapId(BITMAP_H7MODALBACKGROUNDSMALL_ID), 133, 61);
    GUI_ConfLoaderPopup.setShadeColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    GUI_ConfLoaderPopup.setShadeAlpha(100);
    loader1.setXY(7, 0);
    GUI_ConfLoaderPopup.add(loader1);

    add(GUI_ConfLoaderPopup);
}
